...
def generate_summary_report(data, file_path):
    """
    ...
    sheet = add_sheet(workbook, 'Summary Report')
    ...
    add_chart(sheet, chart_type='bar', data_range='A1:C4', chart_title='Sales by Category', chart_position='A10')

    workbook.save(file_path)
    print(f'Excel summary report generated at {file_path}')

def main():
    # Example usage
    file_path = 'summary_report.xlsx'
    data = pd.DataFrame({
    ...
    generate_summary_report(data, file_path)
